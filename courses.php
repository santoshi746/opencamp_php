...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav mx-auto">
              ...
              <a class="nav-link active" href="web_development.php" >Web development</a>
      ...
      <iframe src="web_development.html" height="600px" width="1550px" name="frame_show" frameborder="0"></iframe>
